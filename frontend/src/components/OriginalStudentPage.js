...
const GetAllStdDetailsPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setStudentID(''); // Reset the form after successful submission
      })
      .catch((error) => {
  ...
  return (
    <div className="page-background bg-purple-200 h-screen">
      <div className="form-container mx-auto w-1/3 p-4 ">
        ...
        >
          <div className="flex flex-col mb-2">
            <h2 className="text-2xl font-bold my-8 mb-8 flex justify-center">Student Detail Extract</h2>
          ...
          <div className="flex">
            <button className="mx-2 bg-blue-500 text-white font-bold rounded hover:bg-green-500 mt-5 mb-2" type="submit">
              Submit
            </button>
          </div>
        </form>
      ...
      <div className='flex flex-col items-center'>
        ...
        {responseData && Object.keys(responseData).length === 0 ? (
          <h2 className="font-bold text-2xl mt-4 text-red-600">Student not Mapped or Doesn't Exist!</h2>
        ) : null}
          ...
          <table className="border-collapse border border-gray-500 mt-14 ">
            <thead>
              <tr>
                ...
                <th className="border border-black bg-blue-300 px-4 py-2">DOB</th>
                ...
                <th className="border border-black bg-blue-300 px-4 py-2">Batch</th>
